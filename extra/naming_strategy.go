...
func SetNamingStrategy(api jsoner.API, translate func(string) string) {
	api.RegisterExtension(&namingStrategyExtension{jsoner.DummyExtension{}, translate})
}
...
func (extension *namingStrategyExtension) UpdateStructDescriptor(structDescriptor *jsoner.StructDescriptor) {
