...
func RegisterTimeAsInt64Codec(api jsoner.API, precision time.Duration) {
...
func (codec *timeAsInt64Codec) Decode(ptr unsafe.Pointer, iter *jsoner.Iterator) {
...
func (codec *timeAsInt64Codec) Encode(ptr unsafe.Pointer, stream *jsoner.Stream) {
	ts := *((*time.Time)(ptr))
