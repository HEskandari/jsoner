...
func Test_disallowUnknownFields(t *testing.T) {
	t.Skipf("Encoder API should be removed")
	//should := require.New(t)
	//type TestObject struct{}
	////var obj TestObject
	//decoder := jsoner.NewDecoder(bytes.NewBufferString(`{"field1":100}`))
...
func Test_new_decoder(t *testing.T) {
	...
	//decoder2 := jsoner.NewDecoder(bytes.NewBufferString(`[1][2]`))
	//arr1 := []int{}
...
func Test_use_number(t *testing.T) {
	...
	//decoder1.UseNumber()
	//decoder2 := jsoner.NewDecoder(bytes.NewBufferString(`123`))
	//decoder2.UseNumber()
	//var obj1 interface{}
...
func Test_decoder_more(t *testing.T) {
	t.Skipf("Encoder API should be removed")
	//should := require.New(t)
	//decoder := jsoner.NewDecoder(bytes.NewBufferString("abcde"))
